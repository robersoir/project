...
fun AddProductScreen(navController: NavController, onProductAdded: () -> Unit) {
    ...
    var productThings by remember { mutableStateOf("")}
    ...
    var productThingsError by remember { mutableStateOf(false)}
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(text = "Add Your car", fontSize = 30.sp, color = Color.White)
                },
                navigationIcon = {
                    IconButton(onClick = {
        ...
        content = {
            LazyColumn(
                ...
                item {
                    ...
                    TextField(
                        value = productThings,
                        onValueChange = { productThings = it },
                        label = { Text("Product Things") },
                        modifier = Modifier.fillMaxWidth()
                    )
                    Spacer(modifier = Modifier.height(8.dp))
                    TextField(
                    ...
                    if (productThingsError) {
                        Text("Product things is required", color = Color.Red)
                    }
                    ...
                    Button(
                        onClick = {
                            ...
                            productThingsError = productThings.isBlank()
